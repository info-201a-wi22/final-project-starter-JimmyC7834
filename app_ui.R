...
#   "Chart",
#   titlePanel("Air Pollutants Emissions of Countries from 1990 to 2020"),
#   sidebarLayout(
#     sidebar_content,
#     main_content
#   ),
#   h4("I've used this viusalization to show the pettern of different types of CO2 emissions/air polutants emissions of different countries. By this chart, we could laern the trend of every country on every types of emissions from 1990 to 2020. In this way, when people could find the country they would like to from by looking at the pettern shown for every type of emissions. Overall, I've noticed a growing trend for every emission types in general expect a few region. However, the data collected is often missing for certain types and area. Therefore I've prevent to shown incomplete data by detecting and preventing charts of incomplete data being made when over 60% of the data is missing")
# )
#
# summary_panel <- tabPanel(
#   "Introduction",
#   titlePanel("Intro"),
#   h4("Climate change continues to be a pressing issue around the globe that has differential impacts on individuals based on where they live and their financial status. In this project, I've summarised 5 CO2 emission data to learn the CO2 emission status and growth rate around the world, especially learning countries with hisgest/lowest values so people could learn to reduce CO2 by looking at policies and life style of the speicafied countries."),
#   titlePanel("Summaries of CO2 Emissions of Countries from 1990 to 2020"),
#   h4("Country with Highest Total CO2 Emission"),
#   textOutput("summary2"),
#   h4("Country with Lowest Total CO2 Emission"),
#   textOutput("summary3"),
#   h4("Country with Highest CO2 Emission Growth since 1990"),
#   textOutput("summary4"),
#   h4("Country with Lowest Total CO2 Emission Growth since 1990"),
#   textOutput("summary5"),
#   h4("Average CO2 Emissions across all Countries in 2020"),
...
main_panel <- tabPanel(
  ...
  p("Keywords: Global warming, Air pollution, Extreme Weathers, Environmental Racism"),
  ...
  p("Has climate change always been an issue?"),
  p("What causes and contributes to the climate crisis in the U.S?"),
  ...
  p("Who is most vulnerable to climate change issues?"),
  p("Which state has the most/least intense climate (for example, intense temperature change)?"),
  h2("Dataset"),
  h4("First Dataset"),
